...
// A `get` (not a top-level `final`) so the category labels re-evaluate
// `tr()` with the current language every time this is read, instead of
// being baked in once at first access.
List<BudgetCategory> get budgetCategories => [
  BudgetCategory(
    label: tr('budget_category_accommodation'),
  ...
  BudgetCategory(
    label: tr('budget_category_transport'),
  ...
  BudgetCategory(
    label: tr('budget_category_shopping'),
  ...
  BudgetCategory(
    label: tr('budget_category_activities'),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 8),
                        Text(
                          'RM ${totalSpent.toStringAsFixed(0)} ${tr('budget_spent')} · '
                          'RM ${(_totalBudget - totalSpent).toStringAsFixed(0)} ${tr('budget_remaining')}',
                          style: TextStyle(
