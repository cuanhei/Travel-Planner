...
class _ExpenseTrackerScreenState extends State<ExpenseTrackerScreen> {
  // Instance field (not `static final`/top-level), so it's rebuilt fresh —
  // with `tr()` re-evaluated — every time this screen is remounted (the
  // app forces a full navigation remount on language change). The
  // `category` values are kept in sync with `budgetCategories`' translated
  // labels (both call the same `tr()` keys) so category matching/grouping
  // stays correct in every language.
  final _expenses = [
    _Expense(
      title: 'Hotel booking',
      category: tr('budget_category_accommodation'),
      amount: 600,
      date: 'Aug 14',
    ...
    _Expense(
      ...
      category: tr('budget_category_food'),
      amount: 38,
      date: 'Aug 14',
    ...
    _Expense(
      ...
      category: tr('budget_category_transport'),
      amount: 14,
      date: 'Aug 15',
    ...
    _Expense(
      ...
      category: tr('budget_category_shopping'),
      amount: 145,
      date: 'Aug 15',
            ...
            void save() {
              ...
              _upsertExpense(
                _Expense(
                  ...
                  amount: amount,
                  date: existing?.date ?? tr('budget_today'),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      style: TextStyle(color: sheetContext.colors.ink),
                      decoration: InputDecoration(
                        hintText: tr('budget_amount_hint'),
                        filled: true,
                        fillColor: sheetContext.colors.surface,
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(14),
