...
class GroupDashboardScreen extends StatelessWidget {
  ...
  static final _members = [
    (name: 'Alex Tan', color: AppColors.accent, role: 'Organizer'),
    (name: 'Mei Ling', color: Color(0xFF5C6BC0), role: 'Member'),
    (name: 'Arif Hakim', color: Color(0xFF11998E), role: 'Member'),
  ];
      ...
      body: SafeArea(
        child: Column(
          children: [
            DetailHeader(
              title: 'Group Travel',
              subtitle: 'Penang Adventure · 3 members',
              trailing: IconButton(
